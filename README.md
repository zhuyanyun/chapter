# chapter
spring4 x实战代码（entity：book,reader)
 ...
 遇到问题以及解决：
  1， git 403 问题
      ...
      三，疑问：
      1，springboot pom自己引入了maven插件,还需要idea中配置maven吗?
      2，配置文件制定了file反而写入不了，chmoc 777 filename 也设置了，是需要设置应用程序有这个权限吗？默认名称为spring.log
